...
export const products: SeedProduct[] = [
  ...
  // ── Dry-aged ─────────────────────────────────────────
  {
    ...
    longHe: "האנטריקוט מיושן אצלנו על העצם 28 יום, בתא עם בקרת לחות וזרימת אוויר. הבשר מאבד כ-15% ממשקלו, הטעם מתרכז ואנזימים טבעיים מרככים את הסיבים. לפני האריזה אנחנו מסירים את הקליפה היבשה ומוכרים רק את הלב. הבשר מוכשר, מושרה ומומלח, לפני שהוא נכנס לתא היישון.", longEn: "Our entrecôte ages on the bone for 28 days in a chamber with controlled humidity and airflow. It loses about 15% of its weight, the flavour concentrates and natural enzymes soften the fibres. Before packing we trim away the dry crust and sell only the heart. The meat is kashered — soaked and salted — before it enters the ageing chamber.",
  ...
  },
  {
    ...
    longHe: "סטייק צלע בעובי כ-5 ס״מ, עם עצם ארוכה שהקצב מנקה עד הקצה. 35 ימי יישון יבש נותנים לו ארומה עמוקה ואגוזית ומרקם רך במיוחד. כל יחידה שוקלת כקילו וחצי ומספיקה לשלושה-ארבעה סועדים. הבשר מוכשר, מושרה ומומלח, לפני שהוא נכנס לתא היישון.", longEn: "A rib steak about 5 cm thick, on a long bone scraped clean to the tip. 35 days of dry ageing give it a deep, nutty aroma and a notably tender texture. Each piece weighs about 1.5 kg and serves three to four. The meat is kashered — soaked and salted — before it enters the ageing chamber.",
  ...
  },
  {
    ...
    longHe: "21 ימי יישון יבש מרככים את הסיבים של הדנוור ומעמיקים את הטעם הבקרי. השומן התוך-שרירי נשאר, והמרקם עדין יותר מדנוור טרי. אנחנו מסירים את השכבה היבשה וחותכים לסטייקים בעובי שבחרתם. הבשר מוכשר, מושרה ומומלח, לפני שהוא נכנס לתא היישון.", longEn: "21 days of dry ageing soften the Denver's fibres and deepen its beefy flavour. The intramuscular fat stays, and the texture is finer than fresh Denver. We trim the dry outer layer and cut steaks at the thickness you choose. The meat is kashered — soaked and salted — before it enters the ageing chamber.",
